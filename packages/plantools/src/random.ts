...
// cSpell:disable
const names: string[] = [
  "Alejandro", "Alex", "Amara", "Amari", "Amina", "Amir", "Anika", "Aoife", "Ari", "Arjun",
  "Ash", "Avery", "Bailey", "Benoît", "Blair", "Briar", "Cameron", "Camila", "Casey", "Chiara",
  "Dakota", "Devan", "Dmitri", "Drew", "Eden", "Elias", "Ellis", "Elsa", "Emery", "Enzo",
  "Finley", "Freya", "Hugo", "Idris", "Indigo", "Ines", "Isabella", "Jordan", "Jules", "Kendall",
  "Lane", "Layla", "Leif", "Lennox", "Logan", "Luca", "Lucía", "Marley", "Mateo", "Mei",
  "Micah", "Morgan", "Naomi", "Niko", "Noa", "Noor", "Peyton", "Phoenix", "Quinn", "Quinnley",
  "Raj", "Reese", "Remy", "Ren", "Riley", "Rio", "River", "Robin", "Rowan", "Saanvi",
  "Sage", "Sasha", "Seamus", "Shiloh", "Sky", "Skyler", "Sloane", "Sofia", "Soren", "Tao",
  "Tatum", "Taylor", "Thiago", "Tobi", "Yael", "Yara", "Yuna", "Zara", "Zubair", "Zuri",
];
Object.freeze(names);

const airlineCodes = [
  "AAL", "ACA", "AFR", "ANA", "ASA", "BAW", "DAL", "DLH", "ENY", "FFT",
  "JAL", "JBU", "KLM", "NKS", "QFA", "QXE", "SIA", "SKW", "SWA", "UAE",
  "UAL",
];
Object.freeze(airlineCodes);

const airportCodes = [
  "CYBR", "CYCD", "CYEG", "CYLW", "CYQQ", "CYVR", "CYXX", "CYYC", "CYYJ", "CYYZ",
  "EDDF", "EGKK", "EGLL", "EHAM", "KABQ", "KALB", "KANC", "KATL", "KBOI", "KBOS",
  "KBUF", "KBWI", "KCHS", "KCLT", "KCMH", "KCVG", "KDCA", "KDEN", "KDFW", "KDTW",
  "KELP", "KEUG", "KEWR", "KFAI", "KGEG", "KGRR", "KGSO", "KHOU", "KHSV", "KIAD",
  "KIAH", "KIND", "KJFK", "KLAS", "KLAX", "KLEX", "KLGA", "KLIT", "KMCO", "KMDW",
  "KMEM", "KMSP", "KMSY", "KOAK", "KOKC", "KOMA", "KORD", "KORF", "KPDX", "KPHX",
  "KPIT", "KPVD", "KRDU", "KRIC", "KSAN", "KSAV", "KSEA", "KSFO", "KSJC", "KSLC",
  "KSMF", "KSTL", "KTPA", "KTUS", "LFPG", "LIRF", "LSZH", "MMMX", "MPTO", "MROC",
  "NZAA", "OEJN", "OMDB", "RCTP", "RJAA", "RJBB", "RJTT", "RKSI", "RPLL", "SBGR",
  "SCEL", "UUEE", "VHHH", "VTBS", "WSSS", "YSSY", "ZBAA", "ZGGG", "ZKPY", "ZSPD",
];
